  ...
  >
    ...
    <div 
      style={{
        ...
        right: 0,
        bottom: 0,
        backgroundColor: 'rgba(0, 0, 0, 0.3)', // This creates the dark transparent overlay
        zIndex: 1
      }}
    ></div>
    <Card className="absolute md:left-[35%]  z-20 w-full max-w-md mx-auto my-4 font-banglaStraight">
      <CardHeader>
