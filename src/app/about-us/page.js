...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-2xl font-semibold mb-2">আমাদের দৃষ্টি</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">আমাদের মূল্যবোধ</h2>
      ...
      <h2 className="text-2xl font-semibold mb-2">আমাদের সাথে যোগাযোগ করুন</h2>
