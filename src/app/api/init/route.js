...
export async function POST(req) {
  ...
  try {
      ...
      currency: 'BDT',
      tran_id,
      success_url: `${process.env.NEXT_PUBLIC_URL}/api/success`,
      fail_url: `${process.env.NEXT_PUBLIC_URL}/api/fail`,
      cancel_url: `${process.env.NEXT_PUBLIC_URL}/api/cancel`,
      ipn_url: `${process.env.NEXT_PUBLIC_URL}/api/ipn`,
      shipping_method: 'NO',
      product_name: 'N/A',
